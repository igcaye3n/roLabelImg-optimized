...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, defaultFilename=None, defaultPrefdefClassFile=None):
        ...
        # 添加边界限制切换选项
        toggleBoundary = action('Toggle &Boundary Constraint', self.toggleBoundaryConstraint,
                                'Ctrl+B', 'expert', u'Toggle boundary constraint for annotation boxes',
                                checkable=True)
        ...
        self.actions = struct(save=save, saveAs=saveAs, open=open, close=close,
                              ...
                              zoomActions=zoomActions, toggleBoundary=toggleBoundary,
                              fileMenuActions=(
    ...
    def toggleBoundaryConstraint(self):
        """切换边界限制功能"""
        self.canvas.canOutOfBounding = not self.canvas.canOutOfBounding
        self.actions.toggleBoundary.setChecked(not self.canvas.canOutOfBounding)
        status_msg = "边界限制已禁用" if self.canvas.canOutOfBounding else "边界限制已启用"
